  ...
  const handleSubmit = async (
    ...
    if (isConfirming) {
      try {
        ...
        setNotification({
          message:
            "Електронну пошту успішно підтверджено. Ви можете увійти в систему.",
          type: "success",
        });
      ...
      try {
        ...
        setNotification({
          message:
            "Акаунт створено. Будь ласка, введіть код підтвердження з вашої електронної пошти.",
          type: "info",
        });
      } catch (error) {
